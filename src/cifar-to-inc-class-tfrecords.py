...
python cifar-to-inc-class-tfrecords.py --data-directory ../data/cifar-10-inc --dataset-name cifar-10
python cifar-to-inc-class-tfrecords.py --data-directory ../data/cifar-100-inc --dataset-name cifar-100
"""
...
def convert_to(data_set, name:str, data_directory:str, num_shards:int=1, geq:bool=False, class_sep:int=5):
    ...
    # print(labels.shape)
    # print(images.shape)
    images = images[chosen_indices, :, :, :].reshape(-1, rows, cols, depth)
    # print(images.shape)
    num_examples, rows, cols, depth = images.shape
